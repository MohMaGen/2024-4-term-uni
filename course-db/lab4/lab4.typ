...
#figure(
    ...
    tablex(
        ...
        [2.], [Придумать запрос на применение ранжирующих оконных функций Объединение таблиц самих с собой],
        [3.], [Вывести пары атрибутов одной сущности при определенном условии.],
        [4.], [Тоже, что и в пункте 3 с устранением избыточности без оператора DISTINCT. Подзапросы],
        ...
        [10], [ Придумать запрос, использующий подзапрос в предложении FROM Соотнесенные подзапросы.],
